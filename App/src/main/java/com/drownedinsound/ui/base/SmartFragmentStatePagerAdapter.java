 ...
 * {@link android.support.v4.app.FragmentPagerAdapter} at the cost of potentially more overhead
 * when
 ...
 *
 * <p>Here is an example oimplementation of a pager containing fragments of
 * lists:
 *
...
public abstract class SmartFragmentStatePagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (DEBUG) {
            Timber.d("Adding item #" + position + ": f=" + fragment);
        }
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        if (DEBUG) {
            Timber.d("Removing item #" + position + ": f=" + object
            ...
            for (String key : keys) {
                if (key.startsWith("f")) {
                    ...
                    if (f != null) {
                        ...
                        Timber.d(TAG, "Bad fragment at key " + key);
                    }
                }
            }
        }
    ...
    public void clearRegisteredFragments() {
        Timber.d("Clear Registered Fragments");
