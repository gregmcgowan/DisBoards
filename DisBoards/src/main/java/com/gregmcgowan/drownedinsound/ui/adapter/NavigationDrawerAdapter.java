    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item != null) {
            if (navigationDrawerItem == null) {
                ...
                navigationDrawerItem = layoutInflater
                        .inflate(R.layout.navigation_drawer_list_item, null);
            }
            TextView displayNameTextView = (TextView) navigationDrawerItem
                    .findViewById(R.id.navigation_drawer_item_display_text);
