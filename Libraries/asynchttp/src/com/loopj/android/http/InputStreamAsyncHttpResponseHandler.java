...
public abstract class InputStreamAsyncHttpResponseHandler extends
	...
	if (status.getStatusCode() >= 300) {
		...
		inputStream = response.getEntity().getContent();
		 handleSuccess(status.getStatusCode(),response.getAllHeaders(), inputStream);
    ...
    public abstract void handleSuccess(int statusCode, Header[] headers, InputStream inputStream);
